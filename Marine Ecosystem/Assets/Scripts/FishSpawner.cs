...
{
    public Consumer clownFish, angelFish, yellowTang, parrotFish, blacktipReefShark, moorishIdol, damselfish, whitetipReefShark;

    private void Start()
    {
        SpawnFish(clownFish, StartPopulationValues.Clownfish);
        //SpawnFish(angelFish, StartPopulationValues.Angelfish);
